...
WORKDIR /src
COPY ["LambdaASP.NETCoreWebAPI.csproj", "LambdaASP.NETCoreWebAPI/"]
RUN dotnet restore "LambdaASP.NETCoreWebAPI/LambdaASP.NETCoreWebAPI.csproj"

WORKDIR "/src/LambdaASP.NETCoreWebAPI"
COPY . .
RUN dotnet build "LambdaASP.NETCoreWebAPI.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "LambdaASP.NETCoreWebAPI.csproj" \
